 ...
 */
final class Version20230320125738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annee_academique ADD COLUMN grand_total_frais DOUBLE PRECISION NOT NULL');
    }
