 ...
 */
final class Version20230321184236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etudiant_annee_academique (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, identite_id INTEGER NOT NULL, adresse_id INTEGER DEFAULT NULL, promotion_actuelle_id INTEGER NOT NULL, inscription_id INTEGER NOT NULL, matricule VARCHAR(255) NOT NULL, telephone_tuteur VARCHAR(255) NOT NULL, has_reussie BOOLEAN NOT NULL, CONSTRAINT FK_9975628AE5F13C8F FOREIGN KEY (identite_id) REFERENCES identite (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9975628A4DE7DC5C FOREIGN KEY (adresse_id) REFERENCES adresse (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9975628A378EAEAC FOREIGN KEY (promotion_actuelle_id) REFERENCES promotion_concrete (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9975628A5DAC5993 FOREIGN KEY (inscription_id) REFERENCES inscription (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
