 ...
 */
final class Version20230320123651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entreprise (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, adresse_id INTEGER NOT NULL, CONSTRAINT FK_D19FA604DE7DC5C FOREIGN KEY (adresse_id) REFERENCES adresse (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D19FA604DE7DC5C ON entreprise (adresse_id)');
        $this->addSql('CREATE TABLE etudiant_annee_academique (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, identite_id INTEGER NOT NULL, adresse_id INTEGER DEFAULT NULL, promotion_actuelle_id INTEGER NOT NULL, matricule VARCHAR(255) NOT NULL, telephone_tuteur VARCHAR(255) NOT NULL, has_reussie BOOLEAN NOT NULL, CONSTRAINT FK_9975628AE5F13C8F FOREIGN KEY (identite_id) REFERENCES identite (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9975628A4DE7DC5C FOREIGN KEY (adresse_id) REFERENCES adresse (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9975628A378EAEAC FOREIGN KEY (promotion_actuelle_id) REFERENCES promotion_concrete (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE frais_abstrait (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, designation VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL)');
        ...
        $this->addSql('CREATE TABLE inscription (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, promotion_concrete_id INTEGER NOT NULL, etudiant_annee_academique_id INTEGER NOT NULL, date DATETIME NOT NULL, observation VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_5E90F6D62302286B FOREIGN KEY (promotion_concrete_id) REFERENCES promotion_concrete (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5E90F6D6FD47D769 FOREIGN KEY (etudiant_annee_academique_id) REFERENCES etudiant_annee_academique (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        , password VARCHAR(255) NOT NULL, notification_non_lu INTEGER NOT NULL)');
